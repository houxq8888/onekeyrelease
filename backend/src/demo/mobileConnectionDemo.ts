...
export class MobileConnectionDemo {
   ...
   * 演示配对会话创建
   */
  private static async demoPairingSession(): Promise<void> {
   ...
   * 演示设备注册
   */
  private static async demoDeviceRegistration(): Promise<void> {
   ...
   * 演示配对流程
   */
  private static async demoPairingProcess(): Promise<void> {
   ...
   * 演示统计信息
   */
  private static demoStatistics(): void {
    logger.info('📱 4. 统计信息');

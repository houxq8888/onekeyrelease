...
router.get('/', authMiddleware, async (req, res) => {
    try {
        ...
        const result = await TemplateService.getTemplates(filter, parseInt(page), parseInt(limit));
        res.json({
            success: true,
...
// 获取预设模板
router.get('/preset/list', authMiddleware, async (_req, res) => {
    try {
...
// 获取分类列表
router.get('/categories/list', authMiddleware, async (_req, res) => {
    try {

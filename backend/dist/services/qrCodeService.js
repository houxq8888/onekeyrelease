...
export class QRCodeService {
     ...
     * @param options 二维码选项
     */
    static async generateURLQRCode(url, options = {}) {
        try {
     ...
     * @param options 二维码选项
     */
    static async generateTextQRCode(text, options = {}) {
        try {
     ...
     * @param options SVG选项
     */
    static async generateSVGQRCode(data, options = {}) {
        try {
     ...
     * @param qrCodeData 二维码数据
     */
    static validateQRCodeData(qrCodeData) {
        try {
            const parsedData = JSON.parse(qrCodeData);
            // 基本验证
     ...
     * @param qrCodeData 二维码数据
     */
    static getQRCodeInfo(qrCodeData) {
        try {
            const parsedData = JSON.parse(qrCodeData);
     ...
     * @param qrCodeData 二维码数据
     */
    static getQRCodeDataURL(qrCodeData) {
     ...
     */
    static async batchGenerateQRCode(items, generator) {
        const results = [];
